	...
	<div class="navbar" role="navigation">
		...
		<div class="container-fluid">		
	        ...
	        <ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown visible-md visible-lg">
	        		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img class="user-avatar" style="border-radius:20px;" src="assets/img/avatar.jpg" alt="user-mail">Scott@anpac.net</a>
	        		<ul class="dropdown-menu">
						<li class="dropdown-menu-header">
			...
			<div class="sidebar ">
				...
				<div class="sidebar-footer">					
					...
					<div class="copyright text-center">
						<small>Proton <i class="fa fa-coffee"></i> by <a href="http://naztemplate.com/">Naztemplate</a></small>
					</div>					
				</div>	
