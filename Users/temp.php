			...
			<div class='site-header' style='z-index: 9'>
				...
				<div class='container' style='z-index: 9; '>
					<a href='index.html' id='branding'>
						<img src='Images/Logos/TempLogo2.png' alt='' class='logo'>
						<div class='logo-text'>
							<h1 class='site-title'><span class='GText'>Johnson Financial</span></h1>
							<small class='site-description'><span class='GText'>Investing For Your Future</span></small>
						</div>
					</a> <!-- #branding -->
					...
					<div class='main-navigation'>
						...
						<ul class='menu'>
							<li class='menu-item current-menu-item'><a href='index.html'>Home</a></li>
								...
								<li class='menu-item'><a href='news.html'>Careers</a></li>
							...
							if(isUserLoggedIn()) {
								if (checkPermission(array(2))){
								
								echo "<li class='menu-item'><a href='Admin/ManagmentPortal/'>Admin</a></li>";
								}
								}
					echo "
						</ul> <!-- .menu -->
...
<div class='header-banner'></div> 
			...
			<main class='main-content'>
				<div class='fullwidth-block latest-projects-section' style='background-image: '../html5up-halcyonic/assets/css/images/bg01.jpg''>
					<div class='container' style='background-image: '../html5up-halcyonic/assets/css/images/bg01.jpg''>
